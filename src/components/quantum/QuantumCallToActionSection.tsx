...
const QuantumCallToActionSection = ({ topicSlug }: { topicSlug: string }) => {
  return (
    <section className="container mx-auto px-4 py-10">
      <Card className="bg-scholarly-blue text-white">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-serif">Advance Quantum Research</CardTitle>
        </CardHeader>
        <CardContent className="text-center space-y-4">
          <p className="text-scholarly-lightGray">
            Contribute to the growing body of quantum computing research and applications.
          </p>
...
export default QuantumCallToActionSection;
