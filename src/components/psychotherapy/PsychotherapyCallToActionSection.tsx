...
const PsychotherapyCallToActionSection = ({ topicSlug }: { topicSlug: string }) => {
  return (
    <section className="container mx-auto px-4 py-10">
      <Card className="bg-scholarly-blue text-white">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-serif">Advance Mental Health Research</CardTitle>
        </CardHeader>
        <CardContent className="text-center space-y-4">
          <p className="text-scholarly-lightGray">
            Contribute to the evidence base for effective mental health treatments and interventions.
          </p>
...
export default PsychotherapyCallToActionSection;
