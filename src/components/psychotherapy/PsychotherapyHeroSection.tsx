...
import { psychotherapyPublications } from '@/data/psychotherapyData';

type PsychotherapyHeroSectionProps = {
  topic: Topic;
};

const PsychotherapyHeroSection = ({ topic }: PsychotherapyHeroSectionProps) => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-white mb-4">Effectiveness of Psychotherapy</h1>
                  ...
                  <HoverCard>
                    ...
                    <HoverCardContent className="w-80 p-0 overflow-hidden">
                      ...
                      <div className="p-4 space-y-3">
                        {psychotherapyPublications.length > 0 ? (
                          psychotherapyPublications.slice(0, 3).map((publication, index) => (
...
export default PsychotherapyHeroSection;
