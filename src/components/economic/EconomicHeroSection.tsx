...
const EconomicHeroSection = ({ topic }: EconomicHeroSectionProps) => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-white mb-4">Economic Impacts of Immigration</h1>
          ...
          <div className="w-full md:w-auto">
            <Card className="bg-white shadow border-none">
              <CardHeader className="pb-2">
                <CardTitle className="text-lg">Scholarly Consensus</CardTitle>
              </CardHeader>
              <CardContent>
                <ConsensusIndicator 
...
export default EconomicHeroSection;
