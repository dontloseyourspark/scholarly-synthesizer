...
const EconomicCallToActionSection = ({ topicSlug }: { topicSlug: string }) => {
  return (
    <section className="container mx-auto px-4 py-10">
      <Card className="bg-scholarly-blue text-white">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-serif">Contribute Economic Research</CardTitle>
        </CardHeader>
        <CardContent className="text-center space-y-4">
          <p className="text-scholarly-lightGray">
            Help advance understanding of immigration's economic impacts through rigorous research.
          </p>
...
export default EconomicCallToActionSection;
