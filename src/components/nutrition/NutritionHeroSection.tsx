...
import { nutritionPublications } from '@/data/nutritionData';

type NutritionHeroSectionProps = {
  topic: Topic;
};

const NutritionHeroSection = ({ topic }: NutritionHeroSectionProps) => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-white mb-4">Nutrition Science</h1>
                  ...
                  <HoverCard>
                    ...
                    <HoverCardContent className="w-80 p-0 overflow-hidden">
                      ...
                      <div className="p-4 space-y-3">
                        {nutritionPublications.length > 0 ? (
                          nutritionPublications.slice(0, 3).map((publication, index) => (
